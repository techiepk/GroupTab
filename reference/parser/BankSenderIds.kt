...
object BankSenderIds {
    ...
    val BANK_SENDERS = setOf(
        ...
        "SBIINB", "SBICRD", "SBIPSG", "ONLSBI", "STBANK", "SBIBK",
        ...
        "IDFCFB", "INDBNK", "INDBMK", "OBCBMB", "PNJBMB", "SYNBMB", "UCOBMB",
    ...
    val BANK_SENDER_PATTERNS = listOf(
        ...
        Regex("^[A-Z]{2}-(HDFCBK|HDFCB|HDFC|ICICIT|ICICIB|SBIBNK|SBISMS|SBIBK|AXISBK|AXISB|KOTAKB|KOTMSG|PNBSMS|YESBK|INDUSB|SCBANK|HSBCIN|CITIBK|RBLBNK).*"),
        Regex("^[A-Z]{2}-(BOIIND|UNIONB|CANBNK|IOBCHN|BOBBSR|CENTBK|UCOBNK|PSBBNK|OBCBNK|CORPBK|INDBMK|INDIANBK).*"),
